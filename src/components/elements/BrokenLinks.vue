...
<template>
	...
	<div class="row">
		...
		<div class="col">
			<img src="../../assets/rickrolled.jpg" class="img-thumbnail" alt="Broken Image" />
		...
		<div class="col">
			<a href="https://the-internet.herokuapp.com/status_codes/500" target="_blank">Broken Link</a>
		</div>
	</div>
</template>
